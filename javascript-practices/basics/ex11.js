...
var a1 = [0, 1, 2, 3, 4];
//var a2 = a1.splice(1, 3, [10, 20]); -> [0, Array(2), 4] 가 됨!
var a2 = a1.splice(1, 3, 10);
console.log(a2, a1);

// splice: 3. removeAt() 처럼 동작 -> index부터 count 개를 삭제
console.log("=== removeAt() = splice(index, count) ===");

var a3 = [0, 1, 2, 3, 4];
a3.splice(2, 1); // removeAt(2)
console.log(a3);

// splice: 4. insertAt() 처럼 동작 -> index 자리부터 count 개를 삭제하고 number 삽입
console.log("=== insertAt() = splice(index, count, number) ===");
